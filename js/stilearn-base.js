$(function(){
    ...
    +'        <li><a id="normal-mode" href="#normal-mode">正常</a></li>'
    +'        <li><a id="fixedtop-mode" href="#fixedtop-mode">固定顶部</a></li>'
    +'        <li><a id="fixedside-mode" href="#fixedside-mode">固定侧边栏</a></li>'
    +'        <li><a id="fixedsideonly-mode" href="#fixedsideonly-mode">只固定侧边栏</a></li>'
    +'    </ul>'
    +'    <div class="navigate-mode"><a href="#" class="grd-black corner-bottom"><i class="typicn-cog"></i></a></div>'
    +'</div>';
